...
def database_engine():
    ...
    database_mode = True
    repository_populate.populate_for_database(TEST_DATA_PATH_DATABASE_LIMITED, repo_instance)
    yield engine
...
def session_factory():
    ...
    repo_instance = databaserepository.SqlAlchemyRepository(session_factory)
    database_mode = True
    repository_populate.populate_for_database(TEST_DATA_PATH_DATABASE_FULL, repo_instance)
